...
<div>
<figure class="figure">
    <img src="SubmissionDiagram.png" alt="Figure 3: Process Flow for Pre-qualification " title="Figure 3: Process Flow for Pre-qualification " class="img-responsive img-rounded center-block" width="75%">
    <figcaption class="figure-caption"><strong>Figure 3: Process Flow for Pre-qualification </strong></figcaption>
</figure>
<p></p>
</div>
