...
* code 1.. MS
* code from $us-core-condition-code (preferred)
...
* code ^binding.extension.extension[=].valueCanonical = "http://hl7.org/fhir/us/core/ValueSet/us-core-condition-code-current"
