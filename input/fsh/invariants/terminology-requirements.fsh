...
/* MEASDEV-1102: Update RPS Encounter Profiles */
Invariant: encounter-rps-initial-population
Description: "Encounter: (class must be from RPS encounter class) or (type from 'Encounter Inpatient' or 'Observation Services') or (Encounter location type from 'Inpatient and Observation Locations')"
Severity: #error
