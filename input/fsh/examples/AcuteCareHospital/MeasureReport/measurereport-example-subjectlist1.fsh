...
* group.population.subjectResults.reference = "#list-example-individual-measurereport-list"


Instance: Inline-Instance-for-measurereport-example-subjectlist1-1
