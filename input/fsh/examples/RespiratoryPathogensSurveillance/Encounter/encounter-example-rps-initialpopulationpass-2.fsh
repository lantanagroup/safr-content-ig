...
* hospitalization.admitSource = $admit-source#other "Direct admit"
* hospitalization.admitSource.text = "Direct admit"
* hospitalization.dischargeDisposition = $discharge-disposition#snf "To skilled nursing unit"
* hospitalization.dischargeDisposition.text = "To skilled nursing unit"
* location.locationReference = Reference(location-example-rps-emergency)
