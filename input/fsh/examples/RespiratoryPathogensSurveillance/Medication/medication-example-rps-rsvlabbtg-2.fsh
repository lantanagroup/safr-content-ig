Instance: medication-example-rps-rsvlabbtg-2
InstanceOf: RespiratoryPathogensSurveillanceEventMedication
Title: "Medication - RPS Daily Medication Example RSV Lab BTG 2"
Description: "Medication - Example RPS Daily Medication RSV Lab BTG 2"
Usage: #example
...
* code.coding[+] = $rxnorm#707359
* code.text = "Nasal Saline spray"
* status = #active
* form = $sct#385157007 "Nasal spray"
