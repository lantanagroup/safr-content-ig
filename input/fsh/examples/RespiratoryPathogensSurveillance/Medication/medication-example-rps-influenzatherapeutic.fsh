Instance: medication-example-rps-influenzatherapeutic
InstanceOf: RespiratoryPathogensSurveillanceEventMedication
Title: "Medication - RPS Daily Medication Example Influenza Therapeutic"
Description: "Medication - Example RPS Daily Medication Influenza Therapeutic"
Usage: #example
