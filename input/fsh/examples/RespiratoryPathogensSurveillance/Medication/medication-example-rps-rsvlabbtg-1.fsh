Instance: medication-example-rps-rsvlabbtg-1
InstanceOf: RespiratoryPathogensSurveillanceEventMedication
Title: "Medication - RPS Medication Example RSV Lab BTG 1"
Description: "Medication - Example RPS Medication RSV Lab BTG 1"
Usage: #example
