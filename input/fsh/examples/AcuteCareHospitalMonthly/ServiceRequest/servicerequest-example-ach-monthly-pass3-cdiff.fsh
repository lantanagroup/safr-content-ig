Instance: servicerequest-example-ach-monthly-pass3-cdiff
InstanceOf: AcuteCareHospitalMonthlyReportingServiceRequest
Title: "ServiceRequest - Example ACH Monthly Pass3 Cdiff"
Description: "ServiceRequest - Example ACH Monthly Pass3 - Clostridioides difficile toxin A in Stool by Immunoassay"
Usage: #example
