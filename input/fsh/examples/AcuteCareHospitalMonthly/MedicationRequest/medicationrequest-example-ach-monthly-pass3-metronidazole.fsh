Instance: medicationrequest-example-ach-monthly-pass3-metronidazole
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationRequest
Title: "MedicationRequest - Example ACH Monthly Pass3 Metronidazole"
Description: "MedicationRequest - Example ACH Monthly Pass3 - Metronidazole 500 MG"
Usage: #example
