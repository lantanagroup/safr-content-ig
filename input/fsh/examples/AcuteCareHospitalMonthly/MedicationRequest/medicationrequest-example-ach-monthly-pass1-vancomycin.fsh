Instance: medicationrequest-example-ach-monthly-pass1-vancomycin
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationRequest
Title: "MedicationRequest - Example ACH Monthly Pass1 Vancomycin"
Description: "MedicationRequest - Example ACH Monthly Pass1 - Vancomycin Injectable Solution 50MG"
Usage: #example
...
* requester = Reference(patient-example-ach-monthly-pass1)
