Instance: medicationrequest-example-ach-monthly-pass2-insulin-lispro
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationRequest
Title: "MedicationRequest - Example ACH Monthly Pass2 Insulin Lispro"
Description: "MedicationRequest - Example ACH Monthly Pass2 - Insulin Lispro"
Usage: #example
