Instance: medicationrequest-example-ach-monthly-pass2-dex4-tablet
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationRequest
Title: "MedicationRequest - Example ACH Monthly Pass2 Dex4 Tablet"
Description: "MedicationRequest - Example ACH Monthly Pass2 - Dex4 4 gm chewable tablet X1"
Usage: #example
...
* encounter = Reference(encounter-example-ach-monthly-pass2-emergency)
* encounter.display = "Emergency Encounter"
* authoredOn = "2024-01-31T04:46:00-05:00"
* requester = Reference(patient-example-ach-monthly-pass2)
