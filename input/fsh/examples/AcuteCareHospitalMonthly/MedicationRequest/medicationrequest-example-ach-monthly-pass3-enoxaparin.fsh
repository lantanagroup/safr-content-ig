Instance: medicationrequest-example-ach-monthly-pass3-enoxaparin
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationRequest
Title: "MedicationRequest - Example ACH Monthly Pass3 Enoxaparin"
Description: "MedicationRequest - Example ACH Monthly Pass3 - enoxaparin sodium, 0.4 ML,  100 MG/ML Prefilled Syringe"
Usage: #example
...
* encounter = Reference(encounter-example-ach-monthly-pass3-acute)
* encounter.display = "Critical care visit"
* authoredOn = "2024-02-02T12:21:00-05:00"
* requester = Reference(patient-example-ach-monthly-pass3)
