Instance: patient-example-ach-monthly-pass1
InstanceOf: CrossMeasurePatient
Title: "Patient - Example ACH Monthly Pass1 - LOS/MEN"
Description: "Patient - Example ACH Monthly Pass1 - Late Onset Sepsis and Meningitis (LOS/MEN)"
Usage: #example
