Instance: encounter-example-ach-monthly-pass1
InstanceOf: AcuteCareHospitalMonthlyReportingEncounter
Title: "Encounter - Example ACH Monthly Pass1 - Inpatient"
Description: "Encounter - Example ACH Monthly Pass1 - Hospital Admission"
Usage: #example
...
* diagnosis.condition = Reference(condition-example-diagnosis-ach-monthly-pass1)
...
* location[0].location.display = "ACH Monthly Neonatal critical care"
* location[=].location = Reference(location-example-ach-monthly-nicu-level-iii)
