Instance: encounter-example-ach-monthly-pass2-emergency
InstanceOf: AcuteCareHospitalMonthlyReportingEncounter
Title: "Encounter - Example ACH Monthly Pass2 - Emergency"
Description: "Encounter - Example ACH Monthly Pass2 - Emergency department visit"
Usage: #example
...
* diagnosis.condition = Reference(condition-example-diagnosis-ach-monthly-pass2)
...
* location[0].location.display = "ACH Monthly Emergency Department"
* location[=].location = Reference(location-example-ach-monthly-emergency)
