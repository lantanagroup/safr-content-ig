Instance: encounter-example-ach-monthly-pass3-short-stay
...
* diagnosis.condition = Reference(condition-example-diagnosis-ach-monthly-pass3)
...
* location[=].location = Reference(location-example-ach-monthly-medsurg)
