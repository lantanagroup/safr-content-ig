Instance: procedure-example-ach-monthly-pass1-lumbar
InstanceOf: AcuteCareHospitalMonthlyReportingProcedure
Title: "Procedure - Example ACH Monthly Pass1 Lumbar"
Description: "Procedure - Example ACH Monthly Pass1 - Drainage of Spinal Canal, Percutaneous Approach, Diagnostic"
Usage: #example
* identifier.use = #usual
* identifier.system = "urn:oid:2.16.840.1.113883.19.5.1.698.8"
* identifier.value = "1000510352"
* status = #completed
* code = $icd-10-pcs#009U3ZX "Drainage of Spinal Canal, Percutaneous Approach, Diagnostic"
