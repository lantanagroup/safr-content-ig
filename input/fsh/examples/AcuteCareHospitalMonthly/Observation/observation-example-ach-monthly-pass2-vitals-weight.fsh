Instance: observation-example-ach-monthly-pass2-vitals-weight
InstanceOf: AcuteCareHospitalMonthlyReportingVitalsObservation
Title: "Observation - Example ACH Monthly Pass2 Vitals Weight"
Description: "Observation - Example ACH Monthly Pass2 Vitals Signs: Body weight"
Usage: #example
* status = #final
