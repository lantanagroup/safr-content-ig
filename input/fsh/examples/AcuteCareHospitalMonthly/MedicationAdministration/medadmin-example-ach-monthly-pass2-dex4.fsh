Instance: medadmin-example-ach-monthly-pass2-dex4
InstanceOf: AcuteCareHospitalMonthlyReportingMedicationAdministration
Title: "MedicationAdministration - Example ACH Monthly Pass2 Dex4"
Description: "MedicationAdministration - Example ACH Monthly Pass2 - Dex4 4 gm chewable tablet X1"
Usage: #example
...
* context = Reference(encounter-example-ach-monthly-pass2-emergency)
* context.display = "Emergency Encounter"
* effectiveDateTime = "2024-01-31T04:54:00-05:00"
* request = Reference(medicationrequest-example-ach-monthly-pass2-dex4-tablet)
