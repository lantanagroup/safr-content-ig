Instance: medadmin-example-ach-monthly-pass3-enoxaparin
...
* context = Reference(encounter-example-ach-monthly-pass3-acute)
* context.display = "Critical care visit"
* effectiveDateTime = "2024-02-02T21:04:00-05:00"
* request = Reference(medicationrequest-example-ach-monthly-pass3-enoxaparin)
