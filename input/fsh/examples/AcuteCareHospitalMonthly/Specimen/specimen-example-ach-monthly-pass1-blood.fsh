Instance: specimen-example-ach-monthly-pass1-blood
InstanceOf: AcuteCareHospitalMonthlyReportingSpecimen
Title: "Specimen - Example ACH Monthly Pass1 Blood"
Description: "Specimen - Example ACH Monthly Pass1 - Blood venous from heel"
Usage: #example
