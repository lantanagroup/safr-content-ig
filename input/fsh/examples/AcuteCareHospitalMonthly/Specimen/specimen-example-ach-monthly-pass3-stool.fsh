Instance: specimen-example-ach-monthly-pass3-stool
InstanceOf: AcuteCareHospitalMonthlyReportingSpecimen
Title: "Specimen - Example ACH Monthly Pass3 Stool"
Description: "Specimen - Example ACH Monthly Pass3 - Bloody stool"
Usage: #example
