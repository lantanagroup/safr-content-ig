Instance: specimen-example-ach-monthly-pass1-csf
InstanceOf: AcuteCareHospitalMonthlyReportingSpecimen
Title: "Specimen - Example ACH Monthly Pass1 CSF"
Description: "Specimen - Example ACH Monthly Pass1 - Cerebral spinal fluid from superior articular process of lumbar vertebra"
Usage: #example
