Instance: specimen-example-ach-monthly-pass2-blood-1
InstanceOf: AcuteCareHospitalMonthlyReportingSpecimen
Title: "Specimen - Example ACH Monthly Pass2 Blood 1"
Description: "Specimen - Example ACH Monthly Pass2 - Blood venous from blood vessel of left upper arm - First encounter collection"
Usage: #example
...
Instance: specimen-example-ach-monthly-pass2-blood-2
InstanceOf: AcuteCareHospitalMonthlyReportingSpecimen
Title: "Specimen - Example ACH Monthly Pass2 Blood 2"
Description: "Specimen - Example ACH Monthly Pass2 - Blood venous from blood vessel of left upper arm - Second encounter collection"
Usage: #example
* identifier[0].system = "urn:oid:2.16.840.1.113883.19.5.1.798.32"
* identifier[=].value = "C104082902"
* identifier[=].assigner.display = "LIS"
