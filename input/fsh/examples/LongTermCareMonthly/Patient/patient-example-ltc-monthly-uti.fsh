Instance: patient-example-ltc-monthly-uti
InstanceOf: CrossMeasurePatient
Title: "Patient - Example LTC Monthly - UTI"
Description: "Patient - Example LTC Monthly - UTI"
Usage: #example
...
* identifier.value = "1601191901018808"
* active = true
* name[0].use = #official
* name[=].text = "UTI LTC"
* name[=].family = "LTC"
