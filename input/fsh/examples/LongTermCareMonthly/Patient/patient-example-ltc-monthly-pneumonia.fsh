Instance: patient-example-ltc-monthly-pneumonia
InstanceOf: CrossMeasurePatient
Title: "Patient - Example LTC Monthly - Pneumonia"
Description: "Patient - Example LTC Monthly - Pneumonia"
Usage: #example
...
* identifier.value = "1601191945010308"
* active = true
* name[0].use = #official
* name[=].text = "Pneumonia LTC"
* name[=].family = "LTC"
* name[=].given = "Pneumonia"
