Instance: medadmin-example-ach-daily-initialpopulationpass-1
InstanceOf: AcuteCareHospitalDailyEventMedicationAdministration
Title: "Medication Administration - ACH Daily Medication Administration Example Initial Population Pass 1"
Description: "Medication Administration - ACH Daily Medication Administration Example Initial Population Pass 1"
Usage: #example
* status = #completed
