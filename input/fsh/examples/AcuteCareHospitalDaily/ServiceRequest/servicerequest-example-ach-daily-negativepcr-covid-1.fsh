Instance: servicerequest-example-ach-daily-negativepcr-covid-1
InstanceOf: AcuteCareHospitalDailyEventServiceRequest
Title: "ServiceRequest - Example ACH Daily Negative PCR COVID 1"
Description: "ServiceRequest - Example ACH Daily Negative PCR COVID 1"
Usage: #example
