Instance: servicerequest-example-ach-daily-rsvlabbtg-rsv
InstanceOf: AcuteCareHospitalDailyEventServiceRequest
Title: "ServiceRequest - Example ACH Daily RSV Lab BTG"
Description: "ServiceRequest - Example ACH Daily RSV Lab BTG"
Usage: #example
...
* encounter = Reference(encounter-example-ach-daily-rsvlabbtg)
