Instance: medicationrequest-example-ach-daily-rsvlabbtg-2
InstanceOf: AcuteCareHospitalDailyEventMedicationRequest
Title: "Medication Request - ACH Daily Medication Request Example RSV Lab BTG 2"
Description: "Medication Request - Example ACH Daily Medication Request RSV Lab BTG 2"
Usage: #example
...
* medicationReference.reference = "Medication/medication-example-ach-daily-rsvlabbtg-2"
