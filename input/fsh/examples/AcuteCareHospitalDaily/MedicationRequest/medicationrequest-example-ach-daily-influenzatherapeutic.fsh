Instance: medicationrequest-example-ach-daily-influenzatherapeutic
InstanceOf: AcuteCareHospitalDailyEventMedicationRequest
Title: "Medication Request - ACH Daily Medication Request Example Influenza Therapeutic"
Description: "Medication Request - Example ACH Daily Medication Request Influenza Therapeutic"
Usage: #example
