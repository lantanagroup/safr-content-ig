Instance: encounter-example-ach-daily-rsvlabbtg
InstanceOf: AcuteCareHospitalDailyEventEncounter
Title: "Encounter - ACH Daily Encounter Example RSV Lab BTG"
Description: "Encounter - Example ACH Daily Encounter RSV Lab BTG"
Usage: #example
