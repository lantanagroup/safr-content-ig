Instance: encounter-example-ach-daily-negativepcr-1
InstanceOf: AcuteCareHospitalDailyEventEncounter
Title: "Encounter - ACH Daily Encounter Example Negative PCR 1"
Description: "Encounter - Example ACH Daily Encounter Negative PCR 1"
Usage: #example
