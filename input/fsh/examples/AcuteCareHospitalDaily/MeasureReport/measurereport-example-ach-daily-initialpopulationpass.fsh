Instance: measurereport-example-ach-daily-initialpopulationpass
InstanceOf: DEQMIndividualMeasureReportProfile
Title: "MeasureReport - Example Individual ACH Daily Initial Population Pass"
Description: "MeasureReport - Example Individual ACH Daily Initial Population Pass"
Usage: #example
...
* extension[supplementalData][=].valueReference = Reference(patient-example-ach-daily-initialpopulationpass)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-encounter"
* extension[supplementalData][=].valueReference = Reference(encounter-example-ach-daily-initialpopulationpass-1)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-encounter"
* extension[supplementalData][=].valueReference = Reference(encounter-example-ach-daily-initialpopulationpass-2)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-coverage"
* extension[supplementalData][=].valueReference = Reference(coverage-example-ach-daily-initialpopulationpass)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-condition"
* extension[supplementalData][=].valueReference = Reference(condition-example-diagnosis-ach-daily-initialpopulationpass)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-medication-administration"
* extension[supplementalData][=].valueReference = Reference(medadmin-example-ach-daily-initialpopulationpass-1)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-medication-request"
* extension[supplementalData][=].valueReference = Reference(medicationrequest-example-ach-daily-initialpopulationpass)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-medication-administration"
* extension[supplementalData][=].valueReference = Reference(medadmin-example-ach-daily-initialpopulationpass-2)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-observation-lab-category"
* extension[supplementalData][=].valueReference = Reference(lab-observation-example-ach-daily-initialpopulationpass)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-service-request"
* extension[supplementalData][=].valueReference = Reference(servicerequest-example-ach-daily-initialpopulationpass-covid)
//* extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-specimen"
* extension[supplementalData][=].valueReference = Reference(specimen-example-ach-daily-initialpopulationpass)
* status = #complete
* type = #individual
...
* evaluatedResource[0] = Reference(patient-example-ach-daily-initialpopulationpass)
* evaluatedResource[+] = Reference(encounter-example-ach-daily-initialpopulationpass-1)
* evaluatedResource[+] = Reference(encounter-example-ach-daily-initialpopulationpass-2)
* evaluatedResource[+] = Reference(coverage-example-ach-daily-initialpopulationpass)
* evaluatedResource[+] = Reference(condition-example-diagnosis-ach-daily-initialpopulationpass)
* evaluatedResource[+] = Reference(medadmin-example-ach-daily-initialpopulationpass-1)
* evaluatedResource[+] = Reference(medicationrequest-example-ach-daily-initialpopulationpass)
* evaluatedResource[+] = Reference(medadmin-example-ach-daily-initialpopulationpass-2)
//* evaluatedResource[+] = Reference(medicationrequest-example-ach-daily-initialpopulationpass-2)
* evaluatedResource[+] = Reference(lab-observation-example-ach-daily-initialpopulationpass)
* evaluatedResource[+] = Reference(servicerequest-example-ach-daily-initialpopulationpass-covid)
* evaluatedResource[+] = Reference(specimen-example-ach-daily-initialpopulationpass)