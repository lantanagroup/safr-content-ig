...
//* extension[scoring][0].url = "http://hl7.org/fhir/us/davinci-deqm/StructureDefinition/extension-measureScoring"
...
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
...
* extension[supplementalData][=].valueReference = Reference(patient-example-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-encounter"
* extension[supplementalData][=].valueReference = Reference(encounter-example-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-coverage"
* extension[supplementalData][=].valueReference = Reference(coverage-example-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-condition"
* extension[supplementalData][=].valueReference = Reference(condition-example-diagnosis-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-medication-administration"
* extension[supplementalData][=].valueReference = Reference(medadmin-example-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-medication-request"
* extension[supplementalData][=].valueReference = Reference(medicationrequest-example-ach-daily-influenzatherapeutic)
//* extension[supplementalData][+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-MeasureReport.supplementalDataElement.reference"
//* extension[supplementalData][+].valueReference.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-criteriaReference"
* extension[supplementalData][+].valueReference.extension[criteriaReference].valueString = "sde-immunization"
* extension[supplementalData][=].valueReference = Reference(immunization-example-ach-daily-influenzatherapeutic)
* status = #complete
* type = #individual
