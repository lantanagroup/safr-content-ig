Instance: patient-example-ach-daily-negativepcr
InstanceOf: CrossMeasurePatient
Title: "Patient - ACH Daily Patient Example Negative PCR"
Description: "Patient - Example ACH Daily Patient Negative PCR"
Usage: #example
...
* active = true
* name[0].use = #official
* name[=].text = "ACHDaily NegativePCR"
