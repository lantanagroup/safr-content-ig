Instance: condition-example-diagnosis-ach-daily-influenzatherapeutic
InstanceOf: Condition
Title: "Condition - ACH Daily Condition Example Influenza Therapeutic"
Description: "Condition - Example ACH Daily Condition Influenza Therapeutic"
Usage: #example
...
* subject.reference = "Patient/patient-example-ach-daily-influenzatherapeutic"
