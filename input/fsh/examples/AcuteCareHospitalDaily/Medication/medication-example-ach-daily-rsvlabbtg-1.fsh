Instance: medication-example-ach-daily-rsvlabbtg-1
InstanceOf: AcuteCareHospitalDailyEventMedication
Title: "Medication - ACH Daily Medication Example RSV Lab BTG 1"
Description: "Medication - Example ACH Daily Medication RSV Lab BTG 1"
Usage: #example
