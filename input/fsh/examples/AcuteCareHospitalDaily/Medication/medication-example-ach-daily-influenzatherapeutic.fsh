Instance: medication-example-ach-daily-influenzatherapeutic
InstanceOf: AcuteCareHospitalDailyEventMedication
Title: "Medication - ACH Daily Medication Example Influenza Therapeutic"
Description: "Medication - Example ACH Daily Medication Influenza Therapeutic"
Usage: #example
