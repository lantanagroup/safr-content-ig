Instance: specimen-example-ach-daily-negativepcr-1
InstanceOf: AcuteCareHospitalDailyEventSpecimen
Title: "Specimen - ACH Daily Specimen Example Negative PCR 1"
Description: "Specimen - Example ACH Daily Specimen Negative PCR 1"
Usage: #example
